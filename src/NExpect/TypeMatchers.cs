...
namespace NExpect
{
    ...
    {
        /// <summary>
        /// Assert that the provided item is of type T or inherits or implements T
        /// </summary>
        /// <param name="be"></param>
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static IMore<T> A<T>(
            this IBe<T> be
        )
        {
            return be.A<T>(NULL_STRING);
        }
        ...
        )
        {
            return be.AddMatcher(actual =>
            {
                ...
                var passed = actualType == expected;
                return new MatcherResult(
                    passed,
                    FinalMessageFor(
                        () => $"Expected {actual} [ {actualType} ] to be a {expected}",
                        customMessageGenerator
                    )
                );
            });
